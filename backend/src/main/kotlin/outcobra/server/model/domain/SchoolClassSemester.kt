...
@Entity
data class SchoolClassSemester(@ManyToOne val schoolClass: SchoolClass = SchoolClass(),
                               @ManyToOne @QueryInit("schoolYear", "timetable") val semester: Semester = Semester(),
