...
class MarkGroupTest {
    ...
    fun checkWeightingSimple() {
        ...
        assertThat(group.getValue()).isEqualTo(5.0)
    }
    ...
    fun checkWeightingComplex() {
        ...
        assertThat(group.getValue()).isCloseTo(4.1428, Offset.offset(0.0001))
    }
    ...
    fun checkCompositing() {
        ...
        assertThat(group1.getValue()).isCloseTo(2.7142, Offset.offset(0.0001))
        ...
        assertThat(group2.getValue()).isEqualTo(4.2)

        val group3 = MarkGroup()
        group3.marks = ArrayList()
        arrayOf(group1, group2).forEach(addMarkTo(group3))

        assertThat(group3.getValue()).isCloseTo(3.3510, Offset.offset(0.0001))
    }
}